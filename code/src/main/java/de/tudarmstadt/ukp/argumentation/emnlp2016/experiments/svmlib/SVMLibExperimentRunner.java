...
{
    public static final String SVM_LIB_PATH = "/usr/bin/";
            ...
            throws IOException
    {
        ...
        for (File testFile : files) {
            ...
            Set<SinglePrediction> singlePredictions = runSingleFold(testFile,
                    new ArrayList<File>(trainingFiles));

            allPredictions.addAll(singlePredictions);
        ...
        for (SinglePrediction sp : allPredictions) {
            cm.increaseValue(sp.getGold(), sp.getPrediction());
        }
